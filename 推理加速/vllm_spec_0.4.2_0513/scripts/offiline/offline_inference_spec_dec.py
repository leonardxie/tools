...
@File    ：offline_inference_spec_dec.py
@IDE     ：PyCharm
@Author  ：解书贵
...
sampling_params = SamplingParams(temperature=0.5, max_tokens=2048, stop_token_ids=[151643, 151645], logits_processors=None)

# Create an LLM.
# llm = LLM(model="lmsys/vicuna-13b-v1.5",
#           draft_model="TinyLlama/TinyLlama-1.1B-Chat-v0.6",
#           speculate_length=5)
llm = LLM(model="/data01/01model_hub/LLM/Qwen1.5-7B-Chat",
          # speculate_length=5,
