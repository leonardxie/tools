...
logger = build_logger("model_worker", f"run_logs/model_worker/model_worker_{worker_id}.log")
...
class VLLMWorker(BaseModelWorker):
    ...
    async def generate_stream(self, params):
        ...
        whether_use_speculate = params.get("whether_use_speculate", True)
        ngram_txt = params.get("ngram_txt", None)
        if not ngram_txt:
            ngram_txt = context
        # Handle stop_str
        stop = set()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--worker-address", type=str, default="http://localhost:22002")
    parser.add_argument(
    ...
    # args.model_path = '/data01/01model_hub/LLM/Qwen1.5-32B-Chat'
    # args.trust_remote_code = True
    # args.disable_log_stats = False
    # args.gpu_memory_utilization = 0.9

    # 投机采样参数
    # args.speculative_model="/data01/01model_hub/LLM/Qwen1.5-1_8B-Chat"
    # args.speculative_model = "[ngram]"
    # args.num_speculative_tokens = 5
    # args.speculative_max_model_len = 32768
    # args.speculative_disable_by_batch_size = 32
    # args.ngram_prompt_lookup_max = 100
    # args.ngram_prompt_lookup_min = 10
